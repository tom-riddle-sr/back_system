...
export default {
    created() {
        ...
        this.items = founded_goods_data_arr.goods_list.reverse()
    },
    ...
    methods: {
        ...
        goods_edit(event) {
            ...
            founded_goods_data_arr.goods_list[event.target.id - 1].editing = !founded_goods_data_arr.goods_list[event.target.id - 1].editing;
            goods_data_arr[founded_goods_data_index] = founded_goods_data_arr
        ...
        goods_edit_finish(goods_id, name, price, date, buyer) {
            ...
            this.edit_name != null ? founded_goods_data_arr.goods_list[goods_id - 1].name = this.edit_name : this.edit_name
            this.edit_price != null ? founded_goods_data_arr.goods_list[goods_id - 1].price = this.edit_price : this.edit_price
            this.edit_date != null ? founded_goods_data_arr.goods_list[goods_id - 1].date = this.edit_date : this.edit_date
            this.edit_buyer != null ? founded_goods_data_arr.goods_list[goods_id - 1].buyer = this.edit_buyer : this.edit_buyer
            founded_goods_data_arr.goods_list[goods_id - 1].editing = !founded_goods_data_arr.goods_list[goods_id - 1].editing;
        ...
        delete_goods(event) {
            ...
            founded_goods_data_arr.goods_list.splice(event.target.id - 1, 1);
            goods_data_arr[founded_goods_data_index] = founded_goods_data_arr
            localStorage.setItem('goods_data_arr', JSON.stringify(goods_data_arr));
            this.items = founded_goods_data_arr.goods_list.reverse()
        },
